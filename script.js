...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function populateStateDropdown() {
    const stateDropdown = document.getElementById("stateSel");
    const states = [
      "Andhra Pradesh",
      "Arunachal Pradesh",
      "Assam",
  ...
  function populateDistrictDropdown(selectedState) {
    ...
    districtDropdown.innerHTML =
      '<option value="" selected="selected">Please select district</option>'; // Reset the dropdown
    ...
    districtDropdown.style.fontFamily = "Quicksand";
  }
